...
export class PlayerCardComponent {
  ...
  ascend() {
    this.swal.confirm({
      ...
      text: 'This will reset your collectibles, gold, level, and equipment. It will also increase your max level and the speed at which you gain levels. Certain Ascension levels carry permanent bonuses, as well.',
      type: 'warning',
