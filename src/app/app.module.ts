...
import {
  ...
  CollectiblesPage,
  StatisticsPage,
  ChatPage, GMCommandsPopover,
  MapPage, PersonalityPopover,
  PetsPage, PetsOverviewPage, PetsItemsPage,
  PremiumPage,
  SettingsPage,
  GuildPage, GuildOverviewPage, GuildMembersPage, GuildManagePage, GuildBuildingsPage,
...
const deepLinks: DeepLinkConfig = {
  links: [
    ...
    { component: GuildOverviewPage, name: 'Guild Overview',     segment: 'overview' },
    { component: GuildMembersPage,  name: 'Guild Members',      segment: 'members' },
    { component: GuildManagePage,   name: 'Guild Manage',       segment: 'manage' },
    { component: GuildBuildingsPage,name: 'Guild Buildings',    segment: 'buildings' },
    { component: MapPage,           name: 'Map',                segment: 'map' },
    { component: PetsPage,          name: 'Pets',               segment: 'pets' },
    { component: PetsOverviewPage,  name: 'Pet Overview',       segment: 'overview' },
    { component: PetsItemsPage,     name: 'Pet Items',          segment: 'items' },
...
@NgModule({
  declarations: [
    ...
    CollectiblesPage,
    StatisticsPage,
    ChatPage, ChatWindowComponent, GMCommandsPopover,
    MapPage, PersonalityPopover,
    PetsPage, PetsOverviewPage, PetsItemsPage,
    PremiumPage,
    SettingsPage,
