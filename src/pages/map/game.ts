...
export class Game {
  ...
  getGenderById(gender: string) {
    switch(gender) {
      ...
      case 'Monster-blue':          return 120;
      case 'Monster-red':           return 121;
      case 'Monster-green':         return 122;
      case 'Monster-gold':          return 123;
      case 'MagicalMonster-blue':   return 124;
      case 'MagicalMonster-red':    return 125;
      case 'MagicalMonster-green':  return 126;
      case 'MagicalMonster-gold':   return 127;
